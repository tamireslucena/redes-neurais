...
class GrowingNeuralGas:
    ...
    def prune_connections(self, a_max):
        ...
        for u in self.network.copy().nodes():
            if self.network.degree(u) == 0:
                self.network.remove_node(u)

    def fit_network(self, e_b, e_n, a_max, l, a, d, passes=1, plot_evolution=False, r=70):
        # logging variables
    ...
    def plot_clusters(self, clustered_data):
        ...
        color = ['r', 'b', 'orange', 'm', 'g', 'k', 'c', 'y', 'gray', 'pink', 'mediumseagreen', 'lavender', 'coral', 'indigo', 'olive', 'rosybrown', 'navy']
